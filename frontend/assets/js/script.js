...
function loadBackgroundImages() {
  ...
  backgroundImages.morning.onerror = () => {
    console.log('早晨背景載入失敗: assets/images/morning.png');
  };
  ...
  backgroundImages.afternoon.onerror = () => {
    console.log('下午背景載入失敗: assets/images/1219.png');
  };
  ...
  backgroundImages.night.onerror = () => {
    console.log('晚上背景載入失敗: assets/images/1922.png');
  };
  ...
  backgroundImages.lateNight.onerror = () => {
    console.log('深夜背景載入失敗: assets/images/2206.png');
  };
}
...
function initBackgroundMusic() {
  bgMusic = new Audio();
  bgMusic.src = 'assets/music/rain-piano.mp3'; // 預設放鬆音樂
  bgMusic.loop = true;
